    ...
    <div className="flex flex-col h-full bg-background border-l border-border">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-border bg-card/90 backdrop-blur-md sticky top-0 z-10">
        ...
        <div className="flex items-center gap-3">
          <input
            type="text"
            className="w-40 px-4 py-2 rounded-full border border-primary/40 bg-background/80 text-xs font-medium shadow-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-150 placeholder:text-muted-foreground/70"
            value={configVersion}
      ...
      {/* Chat Messages */}
      <div className="flex-1 overflow-y-auto px-4 py-6 space-y-6 bg-gradient-to-b from-background via-card/60 to-background">
      ...
      <form
        ...
        className="flex items-center gap-4 px-6 py-4 border-t border-border bg-card/90 backdrop-blur-md sticky bottom-0 z-10"
        autoComplete="off"
      >
        <input
          className="flex-1 rounded-full border border-border px-5 py-2 text-base focus:outline-none focus:ring-2 focus:ring-primary bg-background/80 shadow-sm"
